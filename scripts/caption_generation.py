...
if pretrained_model == "Conceptual captions":
    ...
    #       "14pXWwB4Zm82rsDdvbGguLfx9F8aM7ovT", base_model_path + "_conceptual_captions"
    #       )
...
# Chose which samples to caption
generated_imgs = os.listdir("/mimer/NOBACKUP/groups/clippin/gen_images/once_val_lidar_selected")
SAMPLE_IDXS = [int(img.split(".")[0].split("_")[0]) for img in generated_imgs]
